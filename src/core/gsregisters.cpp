...
void GS_REGISTERS::write64_privileged(uint32_t addr, uint64_t value)
{
    ...
    {
    case 0x0000:
        printf("[GS_r] Write PMODE: $%08X_%08X\n", value >> 32, value);
        ...
        break;
    case 0x0020:
        printf("[GS_r] Write SMODE2: $%08X_%08X\n", value >> 32, value);
    ...
    case 0x0070:
        ...
        break;
    case 0x0080:
        printf("[GS_r] Write DISPLAY1: $%08X_%08X\n", value >> 32, value);
    ...
    case 0x0090:
        ...
        break;
    case 0x00A0:
        printf("[GS_r] Write DISPLAY2: $%08X_%08X\n", value >> 32, value);
    ...
    case 0x1000:
        ...
        break;
    case 0x1010:
        printf("[GS_r] Write64 GS_IMR: $%08X_%08X\n", value >> 32, value);
