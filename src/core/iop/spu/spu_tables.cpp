...
{
     static const int16_t gauss[0x200] = {
    ...
    out =  ((gauss[0x0FF-i] * (voices[voice].old3)) >> 15);
    out += ((gauss[0x1FF-i] * (voices[voice].old2)) >> 15);
    out += ((gauss[0x100+i] * (voices[voice].old1)) >> 15);
    out += ((gauss[0x000+i] * (voices[voice].next_sample)) >> 15);
