...
Emulator::Emulator() : cdvd(this, &iop_dma),
                       cp0(&dmac),
...
void Emulator::poll_controller()
{
    ...
    update_joystick(JOYSTICK::LEFT, JOYSTICK_AXIS::X, state.lStickXAxis);
    update_joystick(JOYSTICK::LEFT, JOYSTICK_AXIS::Y, state.lStickYAxis);
    update_joystick(JOYSTICK::RIGHT, JOYSTICK_AXIS::X, state.rStickXAxis);
    update_joystick(JOYSTICK::RIGHT, JOYSTICK_AXIS::Y, state.rStickYAxis);
}
